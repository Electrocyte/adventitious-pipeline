...
def blastN_databases() -> dict:
    ...
    # small full bacteria
    # small_full_bacteria_seq  = f"{str(Path.home())}/SequencingData/NCBI_bacteria_full/fasta/small_full_bacteria.fasta"
    ...
    # all_kingdoms = [small_smart_full_bacteria_seq, seq_16S_23S, seq_fungal, cl_viral_seq]
    all_kingdoms = {
        "filter_bacteria": small_smart_full_bacteria_seq,
        "16S_23S": seq_16S_23S,
        "fungal_all": seq_fungal,
    ...
    # print (f"Bacterial (small) all: {os.path.isfile(small_full_bacteria_seq)}")
    print(
    ...
    blastN_libraries = {
        ...
        "16S_23S": seq_16S_23S,
        "bacteria": full_bacteria_seq,
        # "small_bacteria": small_full_bacteria_seq,
        "filter_bacteria": small_smart_full_bacteria_seq,
        "human": full_human_seq,
        "chinese_hamster": chinese_hamster_seq,
        "cviral": cl_viral_seq,
...
def host_coverage_databases() -> dict:
    ...
    # print (f"Chinese_hamster_seq (scaffolds): {Path(chinese_hamster_seq).is_file()}")
    print(
    ...
    host_coverage_libraries = {
        "human": full_human_seq,
        # "chinese_hamster_scaffolds": chinese_hamster_seq,
